...
function updateControls() {
    ...
    ['activeLayerNum', 'activeLayerNum2', 'activeLayerNum3', 'activeLayerNum4', 'activeLayerNum5', 'activeLayerNum6', 'activeLayerNum7', 'activeLayerNum8', 'activeLayerNum9', 'activeLayerNum10', 'bottomLayerNum'].forEach(id => {
        const el = document.getElementById(id);
